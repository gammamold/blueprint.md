...
export const translations = {
  en: {
    ...
    heroHeading2: "BUILD ANYTHING.",
    heroDesc1: "Community .md blueprints for VSTs, apps, UIs and tools.",
    ...
    // How it works
    browseTitle: "BROWSE",
    browseDesc: "Find a blueprint for what you want to build",
    buildTitle: "BUILD",
    ...
    // Search
    searchPlaceholder: "search blueprints, tags, categories...",
    filterAll: "All",
    results: "results",
    ...
    uploadSuccess: "Blueprint submitted for review. It will appear in the marketplace once approved.",
  ...
  es: {
    ...
    heroHeading2: "CONSTRUYE CUALQUIER COSA.",
    heroDesc1: "Blueprints .md de la comunidad para VSTs, apps, UIs y herramientas.",
    ...
    browseDesc: "Encuentra un blueprint para lo que quieres construir",
    ...
    // Search
    searchPlaceholder: "buscar blueprints, etiquetas, categorías...",
    filterAll: "Todo",
    results: "resultados",
    ...
    uploadSuccess: "Blueprint enviado para revisión. Aparecerá en el marketplace una vez aprobado.",
